...
class Loss(nn.Module):
    ...
    def discriminator_loss(self, 
        ...
        real_predictions = torch.cat((
            ...
            real_outputs['frame_disc_output'],
        ...
        fake_predictions = torch.cat((
            torch.zeros((fake_outputs['video_disc_output'])),
            torch.zeros((fake_outputs['frame_disc_output'])),
            torch.zeros((fake_outputs['sync_disc_output'])),
            torch.zeros((fake_outputs['unsync_disc_output'])),
        ))
    ...
    def generator_loss(self,  
        ...
        predictions = torch.cat((
            ...
            fake_outputs['frame_disc_output'],
